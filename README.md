This is the Official German Translation of Noble Fates. New strings will be added here when the game receives updates.
...
```
{
    id Oct.Localization.Languages.German
...
When you run the game, your translations should take effect when you switch to Deutsch.
